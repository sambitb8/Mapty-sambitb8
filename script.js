...
class App {
  ...
  _newWorkout(e) {
    ...
    if (type === `running`) {
      ...
      if (
        ...
        return alert(`All inputs must be positive integers !!!`);
  ...
  _renderWorkout(workout) {
    let html = `     <div class="wrk__list"><button type="button" class="close__bt" data-close>
...
`;
    ...
    const closeBtn = document.querySelector(`.close__bt`);

    closeBtn.addEventListener(`click`, this._reset.bind(this));
  }
  ...
  _reset(e) {
    ...
    const index = this.#workouts.findIndex(idx => idx.id == id);
